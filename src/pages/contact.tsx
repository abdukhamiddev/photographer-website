    ...
    <motion.main className="mb-12" exit={{ opacity: 0 }}>
      ...
      <section className="px-4 mt-8 space-y-8 md:px-12 md:mt-12 md:space-y-0 md:grid md:grid-cols-2 md:gap-8">
        <div>
          ...
          <h1 className="mt-4 text-2xl capitalize font-display text-secondary sm:text-3xl lg:text-4xl">
            Schudle a shooting session
          </h1>

          <ul className="mt-8 space-y-6 md:mt-16">
        ...
        <form
          method="post"
          className="w-full max-w-4xl p-8 shadow rounded-2xl md:p-8"
        ...
        >
          ...
          >
            ...
            <button className="px-6 py-3 text-center text-white transition-colors rounded-md w-52 font-display bg-secondary hover:bg-gray-800 hover:text-gray-200 focus:outline-none focus:bg-gray-800 focus:text-gray-200">
              Book
            </button>
          </fieldset>
        </form>
